...
public final class VersionHelper {
    ...
    public static void runDelayedPlayer(HumanEntity entity, Runnable runnable, long delay) {
        Bukkit.getScheduler().runTaskLater(Menu.getPlugin(), runnable, delay);
    }
    ...
    public static void runRepeated(HumanEntity entity, Runnable runnable, long delay, long repeat) {
        Bukkit.getScheduler().runTaskTimer(Menu.getPlugin(), runnable, delay, repeat);
    }

    public static void runRepeated(Runnable runnable, long delay, long repeat) {
        Bukkit.getScheduler().runTaskTimer(Menu.getPlugin(), runnable, delay, repeat);
    }

    public static void runDelayedAsync(Runnable runnable, long delay, TimeUnit unit) {
        Bukkit.getScheduler().runTaskLaterAsynchronously(Menu.getPlugin(), runnable, delay);
    }

    public static void runRepeatedAsync(Runnable runnable, long delay, long repeat, TimeUnit unit) {
        Bukkit.getScheduler().runTaskTimer(Menu.getPlugin(), runnable, delay, repeat);
    }
